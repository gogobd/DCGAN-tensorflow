...
flags.DEFINE_integer(
    "test_count", 50, "Number of steps after which to run a test [50]")
flags.DEFINE_integer("checkpoint_count", 100,
                     "Number of steps after which to save a checkpoint [100]")
flags.DEFINE_integer("continue_train", 0, "Start at epoch count [0]")
FLAGS = flags.FLAGS
