    ...
    def __init__(self, sess, input_height=108, input_width=108, crop=True,
        ...
        if self.dataset_name == 'mnist':
            ...
            self.data = glob(os.path.join(
                self.dataset_name, self.input_fname_pattern))
    ...
    def train(self, config):
        ...
        for epoch in xrange(config.continue_train, config.epoch):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                if np.mod(counter, config.test_count) == 1:
                    try:
                        ...
                        save_images(samples, self.output_height * image_manifold_size(samples.shape[0]),
                ...
                if np.mod(counter, config.checkpoint_count) == 2:
